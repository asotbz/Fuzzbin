...
class VideoNotFoundError(ValueError):
    ...
    def __init__(self, artist: Optional[str] = None, title: Optional[str] = None, message: Optional[str] = None):
        """
...
class IMVDbVideo(BaseModel):
    ...
    featured_artists: List[IMVDbArtist] = Field(default_factory=list, description="Featured artists")
    ...
    multiple_versions: Optional[bool] = Field(default=None, description="Whether multiple versions exist")
    ...
    verified_credits: Optional[bool] = Field(default=None, description="Whether credits are verified")
    ...
    release_date_stamp: Optional[int] = Field(default=None, description="Release date Unix timestamp")
...
class IMVDbEntityVideo(BaseModel):
    ...
    verified_credits: Optional[bool] = Field(default=None, description="Whether credits are verified")
    artists: List[IMVDbArtist] = Field(default_factory=list, description="Primary artists")
    image: Optional[Any] = Field(default=None, description="Image URLs (can be dict, list, or null)")
...
class IMVDbEntity(BaseModel):
    ...
    artist_videos: List[IMVDbEntityVideo] = Field(default_factory=list, description="Videos as primary artist")
    featured_artist_videos: List[IMVDbEntityVideo] = Field(default_factory=list, description="Videos as featured artist")
    artist_videos_total: Optional[int] = Field(default=None, description="Total artist videos (for pagination)")
    featured_videos_total: Optional[int] = Field(default=None, description="Total featured videos (for pagination)")
