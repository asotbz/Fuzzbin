...
class MasterNotFoundError(ValueError):
    ...
    def __init__(
        ...
        if message:
            ...
            super().__init__(f"Master release not found for artist '{artist}' and title '{title}'")
        else:
...
class ReleaseNotFoundError(ValueError):
    ...
    def __init__(
        ...
        if message:
            ...
            super().__init__(f"Release not found for artist '{artist}' and title '{title}'")
        else:
...
class DiscogsArtist(BaseModel):
    ...
    anv: Optional[str] = Field(default=None, description="Artist name variation on this release")
    join: Optional[str] = Field(default=None, description="Join phrase connecting to next artist")
    role: Optional[str] = Field(default=None, description="Artist role on this release")
    tracks: Optional[str] = Field(default=None, description="Tracks this artist appears on")
    resource_url: Optional[str] = Field(default=None, description="API URL for artist details")
    thumbnail_url: Optional[str] = Field(default=None, description="Artist thumbnail image URL")
...
class DiscogsLabel(BaseModel):
    ...
    resource_url: Optional[str] = Field(default=None, description="API URL for label details")
    thumbnail_url: Optional[str] = Field(default=None, description="Label thumbnail image URL")
...
class DiscogsMaster(BaseModel):
    ...
    artists: List[DiscogsArtist] = Field(default_factory=list, description="Main artists")
    ...
    tracklist: List[DiscogsTrack] = Field(default_factory=list, description="Album tracklist")
    images: List[DiscogsImage] = Field(default_factory=list, description="Cover images")
    videos: List[DiscogsVideo] = Field(default_factory=list, description="Associated videos")
    main_release: Optional[int] = Field(default=None, description="Main release ID for this master")
    main_release_url: Optional[str] = Field(default=None, description="API URL for main release")
    resource_url: Optional[str] = Field(default=None, description="API URL for this master")
...
class DiscogsRelease(BaseModel):
    ...
    released: Optional[str] = Field(default=None, description="Exact release date string")
    ...
    images: List[DiscogsImage] = Field(default_factory=list, description="Cover images")
    videos: List[DiscogsVideo] = Field(default_factory=list, description="Associated videos")
    master_id: Optional[int] = Field(default=None, description="Master release ID this belongs to")
    master_url: Optional[str] = Field(default=None, description="API URL for master release")
    resource_url: Optional[str] = Field(default=None, description="API URL for this release")
    uri: Optional[str] = Field(default=None, description="Discogs web URL")
    data_quality: Optional[str] = Field(default=None, description="Data quality rating")
    is_exact_match: bool = Field(
        default=True,
...
class DiscogsSearchResultItem(BaseModel):
    ...
    master_url: Optional[str] = Field(default=None, description="API URL for master release")
    uri: Optional[str] = Field(default=None, description="Discogs web URL")
    resource_url: Optional[str] = Field(default=None, description="API URL for this result")
