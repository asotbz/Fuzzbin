...
async def list_videos(
    ...
    genre: Optional[List[str]] = Query(default=None, description="Filter by genre"),
    status: Optional[str] = Query(default=None, description="Filter by status"),
    year: Optional[List[int]] = Query(default=None, description="Filter by year"),
    ...
    tag_name: Optional[List[str]] = Query(default=None, description="Filter by tag"),
