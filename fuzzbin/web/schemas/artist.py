...
class ArtistBase(BaseModel):
    ...
    name: Optional[str] = Field(default=None, max_length=255, description="Artist name")
...
class ArtistCreate(ArtistBase):
    ...
    discogs_artist_id: Optional[int] = Field(default=None, description="Discogs artist ID")
...
class ArtistResponse(ArtistBase):
    ...
    video_count: Optional[int] = Field(default=None, description="Number of videos by this artist")
...
class ArtistVideoLink(BaseModel):
    ...
    position: int = Field(default=0, ge=0, description="Position in credits order")
