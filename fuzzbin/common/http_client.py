...
class AsyncHTTPClient:
    ...
    def _log_cache_status(self, response: httpx.Response, method: str, url: str) -> None:
        ...
        extensions = getattr(response, "extensions", {})
        from_cache = extensions.get("from_cache", False) or extensions.get(
    ...
    async def post(
        ...
        **kwargs: Any,
        ...
        return await self._make_request_with_retry("POST", url, json=json, data=data, **kwargs)
    ...
    async def put(
        ...
        **kwargs: Any,
        ...
        return await self._make_request_with_retry("PUT", url, json=json, data=data, **kwargs)
    ...
    async def patch(
        ...
        **kwargs: Any,
        ...
        return await self._make_request_with_retry("PATCH", url, json=json, data=data, **kwargs)
